...
public class TestServicioB {
    ...
    public void TestMultiplicar() {
        ServicioB servicioB = new servicioBImpl(); // uzando el polimorfismo
    ...
    public void multiplicarSumarWithMockito() {
        ServicioA servicioA = Mockito.mock(ServicioA.class); // indicamos que vamos a simular este servicioA
        ...
        // Creamos una instancia de "ServicioB" y la asignamos a la variable
        // "servicioB".
        ServicioB servicioB = new servicioBImpl();

        // Configuramos "servicioB" con el mock de "servicioA" que creamos
        // anteriormente.
        servicioB.setServicioA(servicioA);
